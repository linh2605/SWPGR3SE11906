...
VALUES ( 1, 1, 1, 2, '2025-06-01 10:00:00', 1, 1, 'pending', 'Đau khớp gối, cần khám', 'PENDING', '2025-05-31 12:00:00'
       , '2025-06-29 15:46:22')
	 , ( 2, 2, 2, 13, '2025-06-01 11:00:00', 1, 1, 'pending', 'Đau bụng, nghi viêm ruột', 'PENDING'
	   , '2025-05-31 12:00:00', '2025-06-29 15:46:22')
	 , ( 3, 25, 4, 2, '2025-06-30 08:00:00', 1, 1, 'pending', 'Khám cho con, bị đau họng, sốt', 'PENDING'
	   , '2025-06-29 13:08:14', '2025-06-29 15:46:22')
	 , ( 4, 15, 4, 2, '2025-06-30 08:00:00', 1, 2, 'pending', 'khám cho cháu gái, đau họng, ho, sốt', 'PENDING'
	   , '2025-06-29 13:51:57', '2025-06-29 15:46:22')
	 , ( 5, 15, 4, 2, '2025-07-01 08:00:00', 1, 1, 'pending', 'Khám tiếp lần nữa', 'PENDING', '2025-06-29 15:55:36'
	   , '2025-06-29 15:55:36')
	 , ( 6, 1, 2, 4, '2025-07-23 08:00:00', 1, 1, 'pending', 'as', 'PENDING', '2025-07-21 01:23:54'
	   , '2025-07-21 01:23:54')
	 , ( 7, 1, 2, 4, '2025-07-21 08:00:00', 1, 1, 'pending', '123', 'PENDING', '2025-07-21 01:30:53'
	   , '2025-07-21 01:30:53');
...
CREATE TABLE `contact_messages` (
	...
	CONSTRAINT `check_contact_email` CHECK (REGEXP_LIKE(`email`,
	                                                    _utf8mb3'^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+.[A-Za-z]{2,}$')),
...
VALUES ( 1, 'Nguyễn Văn A', 'nguyenvana@email.com', '0987654321', 'service_feedback'
       , 'Dịch vụ khám bệnh rất tốt, nhưng thời gian chờ hơi lâu', 'pending', 'medium', NULL, '2025-05-31 14:00:00'
       , '2025-05-31 14:00:00')
	 , ( 2, 'Trần Thị B', 'tranthib@email.com', '0987654322', 'incident_report', 'Máy ATM trong bệnh viện bị hỏng'
	   , 'pending', 'high', NULL, '2025-05-31 15:00:00', '2025-05-31 16:00:00')
	 , ( 3, 'Lê Văn C', 'levanc@email.com', '0987654323', 'improvement_suggestion'
	   , 'Nên thêm dịch vụ gửi xe miễn phí cho bệnh nhân', 'pending', 'low', NULL, '2025-05-31 16:00:00'
	   , '2025-05-31 16:00:00')
	 , ( 4, 'Phạm Thị D', 'phamthid@email.com', '0987654324', 'cooperation'
	   , 'Công ty chúng tôi muốn hợp tác về dịch vụ bảo hiểm y tế', 'pending', 'high', NULL, '2025-05-31 17:00:00'
	   , '2025-05-31 17:00:00');
...
CREATE TABLE `doctors` (
	...
	`contract_status`     enum ('ACTIVE','EXPIRED','SUSPENDED') COLLATE utf8mb4_unicode_ci                DEFAULT NULL,
...
INSERT INTO `doctors`
VALUES ( 1, 3, 'Male', '1980-03-15', 'https://hongngochospital.vn/bac-sy/BS%20Ngoai%20Khoa/BS-Trinh%20Minh%20Thanh.jpg'
       , 1, 'Thạc sĩ, Bác sĩ Chuyên khoa II', 'Trên 30 năm công tác tại khoa Ngoại Tổng hợp - Bệnh viện Bạch Mai'
       , 'inactive', 'ACTIVE', '2020-06-11', '2030-06-11', '2025-06-11 03:49:52')
	 , ( 2, 4, 'Male', '1985-07-20', 'https://hongngochospital.vn/_default_upload_bucket/1111.jpg', 2, 'Bác sĩ'
	   , 'Bác sĩ Khoa Chấn thương chỉnh hình - Thần kinh sọ não, Bệnh viện Đa khoa Hồng Ngọc', 'active', 'ACTIVE'
	   , '2020-06-11', '2030-06-11', '2025-06-11 03:49:52')
	 , ( 4, 54, 'Female', '1985-07-20'
	   , 'https://www.vinmec.com/static//uploads/small_11_10_2023_07_19_57_465328_jpeg_1d0835585c.jpg', 3
	   , 'Thạc sĩ, Bác sĩ nội trú, Bác sĩ y khoa, Bác sĩ', 'Khoa ngoại bệnh viện đa khoa Đống Đa từ 2014 – 2025'
	   , 'active', 'ACTIVE', '2020-06-11', '2030-06-11', '2025-06-11 03:49:52')
	 , ( 5, 55, 'Female', '1985-07-20', 'https://hongngochospital.vn/_default_upload_bucket/2_62.png', 1
	   , 'Thạc sĩ, Bác sĩ nội trú', '2014 - 2025: Bác sĩ đa khoa - Đại học Y Hà Nội', 'active', 'ACTIVE', '2020-06-11'
	   , '2030-06-11', '2025-06-11 03:49:52')
	 , ( 6, 56, 'Female', '1985-07-20', 'https://hongngochospital.vn/_default_upload_bucket/tach%20nen.jpg', 2
	   , 'Phó giáo sư, Tiến sĩ', 'Trưởng khoa Cơ Xương Khớp - Bệnh viện Bạch Mai, Chủ tịch Hội Thấp khớp học Việt Nam'
	   , 'active', 'ACTIVE', '2020-06-11', '2030-06-11', '2025-06-11 03:49:52')
	 , ( 7, 57, 'Male', '1985-07-20', 'https://hongngochospital.vn/_default_upload_bucket/1_17.png', 2
	   , 'Thầy thuốc nhân dân, Phó giáo sư, Tiến sĩ'
	   , 'Giám đốc Trung tâm Phẫu thuật Đại trực tràng - Tầng sinh môn Bệnh viện Hữu Nghị Việt Đức', 'active', 'ACTIVE'
	   , '2020-06-11', '2030-06-11', '2025-06-11 03:49:52');
...
CREATE TABLE `news` (
	...
	PRIMARY KEY (`id`),
	KEY `news_users_user_id_fk` (`created_by`),
	CONSTRAINT `news_users_user_id_fk` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 15
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci;
...
VALUES ( 1, 'Chỉ số loãng xương và những ai nên đo loãng xương?'
	 ...
	 , ( 2, 'Viêm cơ, áp xe cơ: Nguyên nhân, triệu chứng, chẩn đoán và điều trị'
	 ...
	 , ( 3, 'Viêm khớp: Nguyên nhân, triệu chứng, chẩn đoán và điều trị'
	 ...
	 , ( 4, 'Các bệnh tim mạch thường gặp ở trẻ em'
	 ...
	 , ( 5, 'Tiêm phòng uốn ván khi mang thai 20 tuần có sao không?'
	   , 'https://www.vinmec.com/static/uploads/small_20191028_101250_994957_tiem_phong_cho_ba_b_max_1800x1800_png_1fc1a868d5.png'
	   , 'Được giải đáp bởi Bác sĩ Nguyễn Vân Anh - Khoa Nhi - Sơ sinh, Bệnh viện Đa khoa ABC123'
	 ...
	 , ( 6, 'Gan: Cơ quan quý giá của cơ thể mà bạn cần biết'
	 ...
	 , ( 7, 'Tin vui: Mở rộng độ tuổi tiêm phòng HPV đến 45 tuổi'
	 ...
	 , ( 8, 'Thuốc Klamentin gói là thuốc gì? Công dụng, cách dùng và lưu ý sử dụng'
	 ...
	 , ( 9, 'Dạ dày: Cơ quan quan trọng của cơ thể mà bạn cần biết'
	 ...
	 , ( 10, 'Suýt tử vong vì lầm tưởng nhồi máu cơ tim là đau dạ dày'
	   ...
	   , '2025-07-19 01:38:08', '2025-07-19 14:06:24', 4)
	 , ( 11, 'Hội thảo: “Giải pháp phòng ngừa Zona ở người mắc bệnh mạn tính, từ khuyến cáo đến bằng chứng lâm sàng”'
	   ...
	   , '2025-07-19 01:38:08', '2025-07-19 14:06:24', 4)
	 , ( 12, 'Những điều bạn cần biết về vắc-xin phòng ho gà'
	   ...
	   , '2025-07-19 01:38:08', '2025-07-19 14:06:24', 4)
	 , ( 13, 'TEST Trung ương thảo luận số lượng đại biểu dự Đại hội Đảng 14', 'https://picsum.photos/600/400'
	 ...
	 , ( 14, 'Biển súc – Vị thuốc quý và những công dụng đối với sức khỏe'
...
VALUES (1, 'vuquanglinhfuhn@gmail.com', '833160', '2025-06-11 03:49:52', 1)
	 , (2, 'vuquanglinhfuhn@gmail.com', '139847', '2025-06-11 03:52:38', 1)
	 , (3, 'vuquanglinhfuhn@gmail.com', '051402', '2025-06-11 03:57:56', 1)
	 , (4, 'vuquanglinhfuhn@gmail.com', '206031', '2025-06-11 03:58:04', 1)
	 , (5, 'vuquanglinhfuhn@gmail.com', '979037', '2025-06-11 03:59:18', 1)
	 , (6, 'vuquanglinhfuhn@gmail.com', '633002', '2025-06-11 04:08:13', 1)
	 , (7, 'vuquanglinhfuhn@gmail.com', '373273', '2025-06-11 04:10:07', 1)
	 , (8, 'vuquanglinhfuhn@gmail.com', '318970', '2025-06-11 04:17:05', 1)
	 , (9, 'vuquanglinhfuhn@gmail.com', '765318', '2025-06-11 04:17:38', 1)
	 , (10, 'vuquanglinhfuhn@gmail.com', '712693', '2025-06-11 04:27:37', 1)
	 , (11, 'vuquanglinhfuhn@gmail.com', '079758', '2025-06-11 04:31:04', 1)
	 , (12, 'vuquanglinhfuhn@gmail.com', '524602', '2025-06-11 04:33:44', 1)
	 , (13, 'vuquanglinhfuhn@gmail.com', '314991', '2025-06-11 04:44:02', 1)
	 , (14, 'vuquanglinhfuhn@gmail.com', '496441', '2025-06-11 05:04:51', 1)
	 , (15, 'vuquanglinhfuhn@gmail.com', '903143', '2025-06-11 05:07:28', 1)
	 , (16, 'vuquanglinhfuhn@gmail.com', '291678', '2025-06-11 05:10:23', 1)
	 , (17, 'vuquanglinhfuhn@gmail.com', '300368', '2025-06-11 05:12:53', 1)
	 , (18, 'vuquanglinhfuhn@gmail.com', '262486', '2025-06-11 05:24:12', 1)
	 , (19, 'vuquanglinhfuhn@gmail.com', '365048', '2025-06-11 05:31:05', 1)
	 , (20, 'vuquanglinhfuhn@gmail.com', '834136', '2025-06-11 05:41:07', 1)
	 , (21, 'vuquanglinhfuhn@gmail.com', '555659', '2025-06-11 05:45:47', 1)
	 , (22, 'vuquanglinhfuhn@gmail.com', '290541', '2025-06-11 05:45:56', 1)
	 , (23, 'vuquanglinhfuhn@gmail.com', '819740', '2025-06-11 05:51:58', 1)
	 , (24, 'vuquanglinhfuhn@gmail.com', '591674', '2025-06-11 06:34:30', 1)
	 , (25, 'vuquanglinhfuhn@gmail.com', '270307', '2025-06-11 06:43:45', 1)
	 , (26, 'vuquanglinhfuhn@gmail.com', '837513', '2025-06-11 07:05:23', 1)
	 , (27, 'vuquanglinhfuhn@gmail.com', '877323', '2025-06-11 07:06:23', 1)
	 , (28, 'vuquanglinhfuhn@gmail.com', '640031', '2025-06-11 07:08:20', 1)
	 , (29, 'vuquanglinhfuhn@gmail.com', '259852', '2025-06-11 07:08:59', 1)
	 , (30, 'vuquanglinhfuhn@gmail.com', '793641', '2025-06-11 07:10:46', 1)
	 , (31, 'vuquanglinhfuhn@gmail.com', '111216', '2025-06-11 07:18:29', 1)
	 , (32, 'linhvqhe176018@fpt.edu.vn', '897398', '2025-06-11 07:20:44', 1)
	 , (33, 'vuquanglinhfuhn@gmail.com', '362767', '2025-06-11 08:23:33', 1)
	 , (34, 'linhvqhe176018@fpt.edu.vn', '019312', '2025-06-11 08:24:39', 1)
	 , (35, 'linhvqhe176018@fpt.edu.vn', '214288', '2025-06-11 08:34:36', 1)
	 , (36, 'linhvqhe176018@fpt.edu.vn', '431157', '2025-06-11 08:38:00', 1)
	 , (37, 'linhvqhe176018@fpt.edu.vn', '182222', '2025-06-11 08:41:57', 1)
	 , (38, 'linhvqhe176018@fpt.edu.vn', '175341', '2025-06-11 09:04:37', 1)
	 , (39, 'linhvqhe176018@fpt.edu.vn', '757382', '2025-06-11 09:05:01', 1)
	 , (40, 'linhvqhe176018@fpt.edu.vn', '903089', '2025-06-11 09:08:13', 1)
	 , (41, 'linhvqhe176018@fpt.edu.vn', '260159', '2025-06-11 09:09:28', 1)
	 , (42, 'linhvqhe176018@fpt.edu.vn', '727063', '2025-06-11 09:13:02', 1)
	 , (43, 'linhvqhe176018@fpt.edu.vn', '438708', '2025-06-11 09:15:11', 1)
	 , (44, 'linhvqhe176018@fpt.edu.vn', '211429', '2025-06-11 09:16:38', 1)
	 , (45, 'linhvqhe176018@fpt.edu.vn', '021942', '2025-06-11 09:18:45', 1)
	 , (46, 'linhvqhe176018@fpt.edu.vn', '207346', '2025-06-11 09:20:37', 1)
	 , (47, 'linhvqhe176018@fpt.edu.vn', '028438', '2025-06-11 09:21:57', 1)
	 , (48, 'linhvqhe176018@fpt.edu.vn', '110622', '2025-06-11 09:22:22', 1)
	 , (49, 'linhvqhe176018@fpt.edu.vn', '229379', '2025-06-11 09:25:35', 1)
	 , (50, 'linhvqhe176018@fpt.edu.vn', '800171', '2025-06-11 09:33:40', 1)
	 , (51, 'linhvqhe176018@fpt.edu.vn', '852085', '2025-06-11 09:34:57', 1)
	 , (52, 'vuquanglinhfuhn@gmail.com', '929670', '2025-06-11 09:35:21', 1)
	 , (53, 'vuquanglinhfuhn@gmail.com', '526685', '2025-06-11 10:53:44', 1)
	 , (54, 'linhvqhe176018@fpt.edu.vn', '276846', '2025-06-11 10:55:03', 1)
	 , (55, 'linhvqhe176018@fpt.edu.vn', '290176', '2025-06-11 11:16:07', 1)
	 , (56, 'linhvqhe176018@fpt.edu.vn', '636847', '2025-06-11 11:20:53', 1)
	 , (57, 'linhvqhe176018@fpt.edu.vn', '454986', '2025-06-11 11:27:23', 1)
	 , (58, 'vuquanglinhfuhn@gmail.com', '168712', '2025-06-23 23:18:32', 1)
	 , (59, 'vuquanglinhfuhn@gmail.com', '388877', '2025-06-23 23:25:34', 1)
	 , (60, 'vuquanglinhfuhn@gmail.com', '257484', '2025-06-23 23:27:48', 1)
	 , (61, 'vuquanglinhfuhn@gmail.com', '633682', '2025-06-23 23:34:28', 1)
	 , (62, 'vuquanglinhfuhn@gmail.com', '779105', '2025-06-23 23:47:59', 1)
	 , (63, 'vuquanglinhfuhn@gmail.com', '240943', '2025-06-23 23:53:54', 1)
	 , (64, 'vuquanglinhfuhn@gmail.com', '494591', '2025-06-23 23:56:00', 1)
	 , (65, 'vuquanglinhfuhn@gmail.com', '513233', '2025-06-23 23:57:57', 1)
	 , (66, 'linhvqhe176018@fpt.edu.vn', '805941', '2025-06-24 10:19:40', 1)
	 , (67, 'linhvqhe176018@fpt.edu.vn', '216657', '2025-06-24 10:23:54', 1)
	 , (68, 'linhvqhe176018@fpt.edu.vn', '943710', '2025-06-24 10:26:46', 1)
	 , (69, 'linhvqhe176018@fpt.edu.vn', '098591', '2025-06-24 10:33:06', 1)
	 , (70, 'linhvqhe176018@fpt.edu.vn', '962103', '2025-06-24 22:27:10', 1)
	 , (71, 'linhvqhe176018@fpt.edu.vn', '553815', '2025-06-24 22:28:34', 1)
	 , (72, 'linhvqhe176018@fpt.edu.vn', '765905', '2025-06-24 22:29:01', 1)
	 , (73, 'linhvqhe176018@fpt.edu.vn', '946846', '2025-06-24 22:31:35', 1)
	 , (74, 'linhvqhe176018@fpt.edu.vn', '237083', '2025-06-24 23:13:31', 1)
	 , (75, 'vu073483@gmail.com', '775918', '2025-06-25 03:59:14', 0)
	 , (76, 'vu0731483@gmail.com', '455499', '2025-06-25 03:59:36', 0)
	 , (77, 'minzz8128@gmail.com', '723286', '2025-06-25 11:21:04', 1)
	 , (78, 'vul407261@gmail.com', '391964', '2025-06-25 11:23:54', 0);
...
INSERT INTO `patient_status_logs`
VALUES (1, 1, 5, 3, '2025-06-23 08:55:43')
	 , (2, 1, 5, 3, '2025-06-23 08:55:46')
	 , (3, 1, 5, 3, '2025-06-23 08:55:49')
	 , (4, 1, 9, 3, '2025-06-23 08:56:06')
	 , (5, 1, 4, 3, '2025-06-23 08:57:09')
	 , (6, 1, 5, 3, '2025-06-23 09:00:26')
	 , (7, 1, 9, 3, '2025-06-23 09:00:28')
	 , (8, 1, 5, 3, '2025-06-23 09:00:30')
	 , (9, 1, 5, 3, '2025-06-23 09:05:42')
	 , (10, 1, 5, 3, '2025-06-23 09:05:44')
	 , (11, 1, 9, 3, '2025-06-23 09:05:46')
	 , (12, 1, 5, 3, '2025-06-23 09:05:48')
	 , (13, 2, 2, 5, '2025-06-24 21:43:36')
	 , (14, 2, 2, 5, '2025-06-24 21:43:39')
	 , (15, 2, 1, 5, '2025-06-24 22:00:23')
	 , (16, 1, 9, 3, '2025-06-25 01:58:02')
	 , (17, 2, 3, 5, '2025-06-25 01:59:57')
	 , (18, 3, 2, 5, '2025-06-25 02:31:16')
	 , (19, 4, 1, 5, '2025-06-25 02:31:21')
	 , (20, 4, 3, 5, '2025-06-25 02:31:24')
	 , (21, 1, 3, 5, '2025-06-25 02:36:32')
	 , (22, 3, 1, 5, '2025-06-25 02:39:32')
	 , (23, 3, 3, 5, '2025-06-25 02:39:35')
	 , (24, 1, 5, 3, '2025-06-25 02:41:30')
	 , (25, 1, 8, 40, '2025-06-25 02:41:42')
	 , (26, 1, 5, 3, '2025-06-25 02:41:45')
	 , (27, 1, 5, 3, '2025-06-25 02:42:16')
	 , (28, 1, 8, 40, '2025-06-25 02:43:17')
	 , (29, 1, 9, 3, '2025-06-25 02:44:15')
	 , (30, 2, 5, 3, '2025-06-25 02:44:36')
	 , (31, 2, 8, 40, '2025-06-25 02:44:41')
	 , (32, 2, 5, 3, '2025-06-25 02:44:49')
	 , (33, 2, 5, 3, '2025-06-25 02:47:40')
	 , (34, 3, 5, 3, '2025-06-25 02:47:49')
	 , (35, 2, 8, 40, '2025-06-25 02:47:52')
	 , (36, 3, 7, 40, '2025-06-25 02:47:56')
	 , (37, 3, 8, 40, '2025-06-25 02:47:58')
	 , (38, 3, 5, 3, '2025-06-25 02:48:02')
	 , (39, 1, 10, 5, '2025-06-25 02:48:47')
	 , (40, 1, 3, 5, '2025-06-25 02:48:58')
	 , (41, 3, 5, 3, '2025-06-25 02:49:02')
	 , (42, 3, 5, 3, '2025-06-25 02:53:08')
	 , (43, 3, 5, 3, '2025-06-25 02:53:33')
	 , (44, 3, 5, 3, '2025-06-25 02:53:48')
	 , (45, 3, 5, 3, '2025-06-25 02:58:51')
	 , (46, 1, 5, 3, '2025-06-25 10:11:09')
	 , (47, 4, 5, 3, '2025-06-25 10:11:50')
	 , (48, 15, 5, 3, '2025-06-25 10:12:15')
	 , (49, 18, 9, 3, '2025-06-25 11:13:43')
	 , (50, 16, 9, 3, '2025-06-25 11:13:48')
	 , (51, 17, 9, 3, '2025-06-25 11:13:50')
	 , (52, 19, 4, 3, '2025-06-25 11:29:56')
	 , (53, 20, 5, 3, '2025-06-25 11:31:47')
	 , (54, 21, 5, 3, '2025-06-25 11:41:49')
	 , (55, 22, 5, 3, '2025-06-25 11:42:12')
	 , (56, 2, 4, 3, '2025-06-30 08:21:27')
	 , (57, 1, 6, 40, '2025-06-30 08:23:27')
	 , (58, 1, 7, 40, '2025-06-30 08:23:29')
	 , (59, 1, 8, 40, '2025-06-30 08:23:30')
	 , (60, 3, 6, 40, '2025-06-30 08:23:31')
	 , (61, 3, 7, 40, '2025-06-30 08:23:32')
	 , (62, 3, 8, 40, '2025-06-30 08:23:32')
	 , (63, 4, 6, 40, '2025-06-30 08:23:54')
	 , (64, 4, 7, 40, '2025-06-30 08:23:56')
	 , (65, 4, 8, 40, '2025-06-30 08:23:59')
	 , (66, 15, 6, 40, '2025-07-01 16:00:42')
	 , (67, 20, 6, 40, '2025-07-01 16:00:46')
	 , (68, 21, 6, 40, '2025-07-01 16:00:57')
	 , (69, 15, 7, 40, '2025-07-01 16:01:10')
	 , (70, 15, 7, 40, '2025-07-01 16:01:23')
	 , (71, 20, 7, 40, '2025-07-01 16:01:41')
	 , (72, 21, 7, 40, '2025-07-01 16:01:55')
	 , (73, 15, 8, 40, '2025-07-01 16:01:56')
	 , (74, 20, 8, 40, '2025-07-01 16:01:57')
	 , (75, 21, 8, 40, '2025-07-01 16:02:01')
	 , (76, 21, 4, 3, '2025-07-01 16:09:18')
	 , (77, 21, 9, 3, '2025-07-01 16:09:41')
	 , (78, 21, 3, 5, '2025-07-01 16:10:31')
	 , (79, 2, 9, 3, '2025-07-01 16:11:10')
	 , (80, 18, 2, 5, '2025-07-01 16:21:08')
	 , (81, 4, 2, 5, '2025-07-01 16:21:13')
	 , (82, 3, 2, 5, '2025-07-01 16:22:10')
	 , (83, 3, 2, 5, '2025-07-01 16:22:23')
	 , (84, 3, 3, 5, '2025-07-01 16:22:27')
	 , (85, 4, 3, 5, '2025-07-01 16:22:29')
	 , (86, 3, 4, 3, '2025-07-01 16:25:21')
	 , (87, 3, 5, 3, '2025-07-01 16:25:28')
	 , (88, 3, 6, 40, '2025-07-01 16:25:40')
	 , (89, 3, 7, 40, '2025-07-01 16:25:41')
	 , (90, 3, 8, 40, '2025-07-01 16:25:43')
	 , (91, 16, 2, 5, '2025-07-01 16:30:40')
	 , (92, 21, 2, 5, '2025-07-01 16:30:43')
	 , (93, 18, 3, 5, '2025-07-01 16:30:54')
	 , (94, 16, 3, 5, '2025-07-01 16:30:55')
	 , (95, 21, 3, 5, '2025-07-01 16:30:56')
	 , (96, 4, 4, 3, '2025-07-01 16:38:50')
	 , (97, 21, 4, 3, '2025-07-01 16:39:15')
	 , (98, 16, 4, 3, '2025-07-01 16:39:20')
	 , (99, 16, 4, 3, '2025-07-01 16:39:41')
	 , (100, 16, 5, 3, '2025-07-01 16:39:54')
	 , (101, 21, 5, 3, '2025-07-01 16:39:54')
	 , (102, 18, 4, 3, '2025-07-01 16:40:13')
	 , (103, 18, 5, 3, '2025-07-01 16:40:16')
	 , (104, 16, 6, 40, '2025-07-01 16:40:28')
	 , (105, 16, 7, 40, '2025-07-01 16:40:31')
	 , (106, 16, 8, 40, '2025-07-01 16:40:33')
	 , (107, 21, 6, 40, '2025-07-01 16:40:37')
	 , (108, 21, 7, 40, '2025-07-01 16:40:41')
	 , (109, 21, 8, 40, '2025-07-01 16:40:42')
	 , (110, 18, 6, 40, '2025-07-01 16:40:47')
	 , (111, 17, 2, 5, '2025-07-02 00:29:45')
	 , (112, 19, 2, 5, '2025-07-02 00:29:49')
	 , (113, 22, 2, 5, '2025-07-02 00:29:53')
	 , (114, 1, 2, 5, '2025-07-02 00:30:01')
	 , (115, 22, 3, 5, '2025-07-02 00:30:03')
	 , (116, 1, 3, 5, '2025-07-02 00:30:07')
	 , (117, 4, 9, 54, '2025-07-02 00:30:28')
	 , (118, 22, 4, 54, '2025-07-02 00:30:56')
	 , (119, 16, 4, 54, '2025-07-02 00:31:04')
	 , (120, 21, 4, 54, '2025-07-02 00:31:07')
	 , (121, 3, 4, 54, '2025-07-02 00:31:15')
	 , (122, 3, 9, 54, '2025-07-02 00:31:38')
	 , (123, 21, 9, 54, '2025-07-02 00:31:39')
	 , (124, 16, 9, 54, '2025-07-02 00:31:39')
	 , (125, 22, 9, 54, '2025-07-02 00:31:40');
...
VALUES ( 1, 1, 'Female', '1990-05-10', '123 Đường Láng, Đống Đa, Hà Nội', 'https://example.com/patient1.jpg'
       , '2025-05-31 12:00:00', 3, 'active')
	 , ( 2, 2, 'Female', '1995-08-25', '456 Nguyễn Huệ, TP Huế', 'https://example.com/patient2.jpg'
	   , '2025-05-31 12:00:00', 1, 'active')
	 , ( 3, 34, 'Male', '2003-05-26', '123 Đường ABC, Quận XYZ, Hà Nội'
	   , '/ClinicManagementSystem/assets/uploads/avatars/6c1f02a170bbc7e59eaa.jpg', '2025-06-24 05:40:41', 9, 'active')
	 , (4, 39, 'Male', '2025-06-04', '123 Đường Láng, Đống Đa, Hà Nội', NULL, '2025-06-24 23:10:11', 9, 'active')
	 , ( 15, 43, 'Female', '1995-06-10', '456 Nguyễn Thị Minh Khai, Hà Nội'
	   , '/ClinicManagementSystem/assets/uploads/avatars/Screenshot 2025-06-06 101210.png', '2025-06-26 12:00:00', 1
	   , 'active')
	 , ( 16, 44, 'Male', '1989-07-15', '789 Nguyễn Trãi, Hà Nội', 'https://example.com/patient41.jpg'
	   , '2025-06-26 12:00:00', 9, 'active')
	 , ( 17, 45, 'Female', '2000-08-20', '234 Hòa Bình, Hà Nội', 'https://example.com/patient42.jpg'
	   , '2025-06-26 12:00:00', 2, 'active')
	 , ( 18, 46, 'Male', '1998-05-22', '567 Thái Hà, Hà Nội', 'https://example.com/patient43.jpg', '2025-06-26 12:00:00'
	   , 6, 'active')
	 , ( 19, 47, 'Female', '1997-10-10', '345 Kim Mã, Hà Nội', 'https://example.com/patient44.jpg'
	   , '2025-06-26 12:00:00', 2, 'active')
	 , ( 20, 48, 'Male', '2001-11-30', '678 Phan Đình Phùng, Hà Nội', 'https://example.com/patient45.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 21, 49, 'Female', '1994-04-18', '123 Lê Duẩn, Hà Nội', 'https://example.com/patient46.jpg'
	   , '2025-06-26 12:00:00', 9, 'active')
	 , ( 22, 50, 'Male', '1999-02-25', '456 Bạch Mai, Hà Nội', 'https://example.com/patient47.jpg'
	   , '2025-06-26 12:00:00', 9, 'active')
	 , ( 23, 51, 'Female', '2002-03-12', '789 Đội Cấn, Hà Nội', 'https://example.com/patient48.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 24, 52, 'Male', '1996-09-01', '234 Nguyễn Lương Bằng, Hà Nội', 'https://example.com/patient49.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , (25, 53, NULL, NULL, NULL, NULL, '2025-06-25 11:16:44', 1, 'active')
	 , ( 26, 43, 'Female', '1995-06-10', '456 Nguyễn Thị Minh Khai, Hà Nội', 'https://example.com/patient40.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 27, 44, 'Male', '1989-07-15', '789 Nguyễn Trãi, Hà Nội', 'https://example.com/patient41.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 28, 45, 'Female', '2000-08-20', '234 Hòa Bình, Hà Nội', 'https://example.com/patient42.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 29, 46, 'Male', '1998-05-22', '567 Thái Hà, Hà Nội', 'https://example.com/patient43.jpg', '2025-06-26 12:00:00'
	   , 1, 'active')
	 , ( 30, 47, 'Female', '1997-10-10', '345 Kim Mã, Hà Nội', 'https://example.com/patient44.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 31, 48, 'Male', '2001-11-30', '678 Phan Đình Phùng, Hà Nội', 'https://example.com/patient45.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 32, 49, 'Female', '1994-04-18', '123 Lê Duẩn, Hà Nội', 'https://example.com/patient46.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 33, 50, 'Male', '1999-02-25', '456 Bạch Mai, Hà Nội', 'https://example.com/patient47.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 34, 51, 'Female', '2002-03-12', '789 Đội Cấn, Hà Nội', 'https://example.com/patient48.jpg'
	   , '2025-06-26 12:00:00', 1, 'active')
	 , ( 35, 52, 'Male', '1996-09-01', '234 Nguyễn Lương Bằng, Hà Nội', 'https://example.com/patient49.jpg'
	   , '2025-06-26 12:00:00', 1, 'active');
...
VALUES (1, 5, 'Female', '1992-11-30', 'https://example.com/receptionist1.jpg', 'Sáng', 'active', '2025-05-31 12:00:00');
...
INSERT INTO `roles`
VALUES (1, 'patient', 'Bệnh nhân đặt lịch hẹn')
	 , (2, 'doctor', 'Bác sĩ khám bệnh')
	 , (3, 'receptionist', 'Lễ tân quản lý lịch hẹn')
	 , (4, 'admin', 'Quản trị viên hệ thống')
	 , (5, 'technician', 'Kỹ thuật viên thực hiện xét nghiệm và chụp chiếu');
...
VALUES ( 2, 2, 2, 1, 'Muốn làm ca sáng để có thời gian cho gia đình', '2025-06-15', '2025-12-31', 'approved', 'change'
       , 6, '2025-05-31 14:00:00', '2025-05-31 13:00:00', '2025-05-31 14:00:00')
	 , ( 3, 1, 1, 3, 'vì lý do gia đình', '2025-02-28', NULL, 'approved', 'change', 0, NULL, '2025-06-28 15:13:11'
	   , '2025-06-28 15:57:29');
...
VALUES (1, 1, '2025-06-02', 'Nghỉ phép', NULL, 'Nghỉ lễ', 'Chờ duyệt', '2025-05-31 12:00:00')
...
VALUES (2, 'Nhi khoa', 'Khám Nhi khoa', 300000, '/images/kham-nhi-khoa.webp', 'SPECIALIST')
	 ...
	 , ( 13, 'Khám sức khỏe cơ bản', 'Tiêu hóa - Tim mạch – Hô hấp - Tai mũi họng - Răng hàm mặt', 1000000
	   , '/images/kham-nhi-khoa.webp', 'COMBO')
	 , ( 14, 'Khám sức khỏe nâng cao'
	   , 'Tim mạch - Tiêu hóa - Thần kinh- Hô hấp - Da liễu - Mắt - Tai mũi họng - Răng hàm mặt', 2000000
	   , '/images/kham-nhi-khoa.webp', 'COMBO')
	 , ( 15, 'Gói khám Nhi khoa', 'Khám nhi - Khám mắt - Răng hàm mặt - Tai mũi họng - Da liễu', 900000
	   , '/images/kham-nhi-khoa.webp', 'COMBO');
...
INSERT INTO `shifts`
VALUES (1, 'Sáng', '08:00:00', '12:00:00', 'Ca làm việc buổi sáng')
...
VALUES (1, 'Cơ Xương Khớp', 'Chuyên khoa điều trị các bệnh về xương khớp')
	 , (2, 'Ngoại Tổng Hợp', 'Chuyên khoa phẫu thuật tổng quát')
	 , (3, 'Nội Tiêu Hóa', 'Chuyên khoa điều trị bệnh tiêu hóa');
...
VALUES (1, 'New', 3, 3)
	 ...
	 , (3, 'Đang đợi khám', 3, 2)
	 , (4, 'Đang khám', 2, 2)
	 , (5, 'Đang chờ bệnh nhân xét nghiệm', 2, 5)
	 , (6, 'Đang xét nghiệm', 5, 5)
	 , (7, 'Chờ kết quả xét nghiệm hoặc chụp quang', 5, 5)
	 , (8, 'Đã lấy kết quả xét nghiệm', 5, 2)
	 , (9, 'Đã khám xong. Đợi thanh toán', 2, 3)
	 , (10, 'Thanh toán xong', 3, 3);
...
VALUES (7, 40, 'Male', '1990-01-01', NULL, NULL, 'Ca sáng', 'active')
	 , (8, 41, 'Female', '1992-02-02', '', NULL, 'Ca chiều', 'Active')
	 , (9, 42, 'Male', '1988-03-03', '', NULL, 'Ca tối', 'Inactive');
...
INSERT INTO `users`
VALUES ( 1, 'patient1', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Nguyễn Văn An', 'an.nguyen@email.com', '0901234567'
       , 1, '2025-05-31 12:00:00', 0)
	 , ( 2, 'patient2', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Trần Thị Bình', 'binh.tran@email.com', '0912345678'
	   , 1, '2025-05-31 12:00:00', 0)
	 , ( 3, 'doctor1', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'ThS.BSCKI Trịnh Minh Thanh', 'thanh.trinh@email.com'
	   , '0923456789', 2, '2025-05-31 12:00:00', 0)
	 , ( 4, 'doctor2', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'BS. Tống Quang Trường', 'hung.le@email.com'
	   , '0934567890', 2, '2025-05-31 12:00:00', 0)
	 , ( 5, 'receptionist1', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Phạm Thị Mai', 'mai.pham@email.com'
	   , '0945678901', 3, '2025-05-31 12:00:00', 0)
	 , ( 6, 'admin1', '74913f5cd5f61ec0bcfdb775414c2fb3d161b620', 'Nguyễn Văn Quản Trị', 'admin@email.com', '0956789012'
	   , 4, '2025-05-31 12:00:00', 0)
	 , (8, 'starpacusa', 'password123', 'quanglinh', 'admin1@example.com', '1234567890', 1, '2025-06-11 03:24:44', 0)
	 , (13, 'john_doe', 'password123', 'John Doe', 'john.doe@example.com', '1234567890', 1, '2025-06-11 05:58:00', 0)
	 , (21, 'john_doe1', 'password123', 'John1 Doe', 'john.dose@example.com', '1234567890', 1, '2025-06-11 06:39:14', 0)
	 , (27, 'johndoe', 'password123', 'John Doe', 'johndoe@example.com', '1234567890', 1, '2025-06-11 11:16:20', 0)
	 , ( 34, 'Vuquanglinh', '241798fad97209ab8197b031da00c24909da2e7a', 'Vũ Quang Linh', 'vuquanglinhfuhn@gmail.com'
	   , '0344768409', 1, '2025-06-23 23:53:11', 0)
	 , ( 39, 'Vuquanglinh265', '241798fad97209ab8197b031da00c24909da2e7a', 'Vũ Quang Linhh', 'linhvqhe176018@fpt.edu.vn'
	   , '0344768409', 1, '2025-06-24 23:10:11', 0)
	 , ( 40, 'tech01', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'KTV Nguyễn Văn A', 'tech01@example.com'
	   , '0912345678', 5, '2025-06-25 01:06:27', 0)
	 , ( 41, 'tech02', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'KTV Trần Thị B', 'tech02@example.com', '0987654321'
	   , 5, '2025-06-25 01:06:27', 0)
	 , ( 42, 'tech03', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'KTV Lê Văn C', 'tech03@example.com', '0901122334', 5
	   , '2025-06-25 01:06:27', 0)
	 , ( 43, 'patient40', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Nguyễn Thị Mai', 'mai.thi.mai@example.com'
	   , '0901234567', 1, '2025-06-26 12:00:00', 0)
	 , ( 44, 'patient41', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Trần Thi Bích', 'tran.thi.bich@example.com'
	   , '0901234568', 1, '2025-06-26 12:00:00', 0)
	 , ( 45, 'patient42', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Phan Minh Tuấn', 'phan.minh.tuan@example.com'
	   , '0901234569', 1, '2025-06-26 12:00:00', 0)
	 , ( 46, 'patient43', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Lê Thị Lan', 'le.thi.lan@example.com'
	   , '0901234570', 1, '2025-06-26 12:00:00', 0)
	 , ( 47, 'patient44', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Nguyễn Minh Phương'
	   , 'nguyen.minh.phuong@example.com', '0901234571', 1, '2025-06-26 12:00:00', 0)
	 , ( 48, 'patient45', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Hoàng Thu Trang', 'hoang.thu.trang@example.com'
	   , '0901234572', 1, '2025-06-26 12:00:00', 0)
	 , ( 49, 'patient46', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Đỗ Văn Toàn', 'do.van.toan@example.com'
	   , '0901234573', 1, '2025-06-26 12:00:00', 0)
	 , ( 50, 'patient47', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Phạm Lan Anh', 'pham.lan.anh@example.com'
	   , '0901234574', 1, '2025-06-26 12:00:00', 0)
	 , ( 51, 'patient48', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Bùi Quang Hải', 'bui.quang.hai@example.com'
	   , '0901234575', 1, '2025-06-26 12:00:00', 0)
	 , ( 52, 'patient49', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'Nguyễn Quang Linh'
	   , 'nguyen.quang.linh@example.com', '0901234576', 1, '2025-06-26 12:00:00', 0)
	 , ( 53, 'hoanganh123', '789b49606c321c8cf228d17942608eff0ccc4171', 'Nguyễn Đình Hoàng Anh', 'minzz8128@gmail.com'
	   , '0976054728', 1, '2025-06-25 11:16:43', 0)
	 , ( 54, 'doctor3', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'BS. Lê Thị Hoa', 'hung.le1@email.com', '0934567890'
	   , 2, '2025-06-26 16:31:13', 0)
	 , ( 55, 'doctor4', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'ThS.BSNT Nguyễn Thị Vân', 'hung.le2@email.com'
	   , '0934567890', 2, '2025-06-26 16:31:13', 0)
	 , ( 56, 'doctor5', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'PGS.TS Nguyễn Thị Ngọc Lan', 'hung.le3@email.com'
	   , '0934567890', 2, '2025-06-26 16:31:13', 0)
	 , ( 57, 'doctor6', 'aafdc23870ecbcd3d557b6423a8982134e17927e', 'TTND.PGS.TS.BS Nguyễn Xuân Hùng'
	   , 'hung.le4@email.com', '0934567890', 2, '2025-06-26 16:31:13', 0);
...
VALUES (1, 1, 'Thứ 2', 3, 15, 1, '2025-05-31 12:00:00', '2025-06-28 15:57:29')
	 , (2, 1, 'Thứ 2', 2, 15, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (3, 1, 'Thứ 3', 3, 15, 1, '2025-05-31 12:00:00', '2025-06-28 15:57:29')
	 , (4, 1, 'Thứ 3', 2, 15, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (5, 1, 'Thứ 4', 3, 15, 1, '2025-05-31 12:00:00', '2025-06-28 15:57:29')
	 , (6, 1, 'Thứ 4', 2, 15, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (7, 1, 'Thứ 5', 3, 15, 1, '2025-05-31 12:00:00', '2025-06-28 15:57:29')
	 , (8, 1, 'Thứ 5', 2, 15, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (9, 1, 'Thứ 6', 3, 15, 1, '2025-05-31 12:00:00', '2025-06-28 15:57:29')
	 , (10, 1, 'Thứ 6', 2, 15, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (11, 2, 'Thứ 2', 1, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (13, 2, 'Thứ 3', 1, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (14, 2, 'Thứ 3', 2, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (15, 2, 'Thứ 4', 1, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (16, 2, 'Thứ 4', 2, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (17, 2, 'Thứ 5', 1, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (18, 2, 'Thứ 5', 2, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (19, 2, 'Thứ 6', 1, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (20, 2, 'Thứ 6', 2, 12, 1, '2025-05-31 12:00:00', '2025-05-31 12:00:00')
	 , (21, 2, 'Thứ 2', 2, 10, 1, '2025-06-27 09:43:35', '2025-06-27 09:43:35')
	 , (22, 4, 'Thứ 2', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (23, 4, 'Thứ 2', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (24, 4, 'Thứ 3', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (25, 4, 'Thứ 3', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (26, 5, 'Thứ 4', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (27, 5, 'Thứ 4', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (28, 5, 'Thứ 5', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (29, 5, 'Thứ 5', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (30, 6, 'Thứ 6', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (31, 6, 'Thứ 6', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (32, 7, 'Thứ 7', 1, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33')
	 , (33, 7, 'Thứ 7', 2, 10, 1, '2025-06-26 16:31:33', '2025-06-26 16:31:33');
...
-- Dump completed on 2025-07-21  2:32:38
