...
<html>
<head>
    <title>Thêm lịch làm việc - Admin Dashboard</title>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="section-title">Thêm lịch làm việc mới</h2>
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/admin/working-schedules">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="doctorId" name="doctorId" required>
                                            ...
                                            <c:forEach var="doctor" items="${doctors}">
                                                <option value="${doctor.doctor_id}">${doctor.user.fullName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle"></i> Thêm lịch làm việc
                                </button>
                            </div>
                        </form>
                    </div>
