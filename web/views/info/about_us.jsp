...
<body>
    ...
    <main class="container my-5">
        ...
        <div class="text-center mb-5">
            <img src="https://picsum.photos/1200/300" alt="G3 Hospital Introduction" class="img-fluid rounded">
        </div>
        ...
        <section class="mb-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="#" class="btn btn-custom mt-3">Khám phá thêm</a>
                </div>
                <div class="col-md-6">
                    <img src="https://picsum.photos/500/400" alt="G3 Hospital Facility" class="img-fluid rounded">
                </div>
            </div>
        </section>

        <!-- Lịch sử hình thành -->
        <section class="mb-5 bg-light-blue">
        ...
        <section class="mb-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="#" class="btn btn-custom mt-3">Xem đội ngũ</a>
                </div>
                <div class="col-md-6">
                    <img src="https://picsum.photos/500/400" alt="G3 Hospital Doctors" class="img-fluid rounded">
                </div>
            </div>
        </section>
        ...
        <section class="mb-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="#" class="btn btn-custom mt-3">Tìm hiểu thêm</a>
                </div>
                <div class="col-md-6">
                    <img src="https://picsum.photos/500/400" alt="G3 Hospital International" class="img-fluid rounded">
                </div>
            </div>
        </section>
    </main>
